...
For Claude Desktop integration, use:
    mcp install /path/to/td_mcp_server/server.py -v TD_API_KEY=your-api-key -v TD_ENDPOINT=api.treasuredata.com
"""
...
if __name__ == "__main__":
    ...
    print("Starting Treasure Data MCP Server...", file=sys.stderr)
